    ...
    <div class="study">
        <div class="study-lf">
            ...
            <ul class="nav" @click="clickTab()">
                <li data-index="0" :class="indexStudy === 0 ? 'active' : ''" >
                    <nuxt-link to="/self_study/MyStudy">我的学习</nuxt-link>
                </li>
                <li data-index="1" :class="indexStudy === 1 ? 'active' : ''">
                    <nuxt-link to="/self_study/MyComment">我的评论</nuxt-link>
                </li>
                <li data-index="2" :class="indexStudy === 2 ? 'active' : ''">
                    <nuxt-link to="/self_study/CourseOrder">课程订单</nuxt-link>
                </li>
                <li data-index="3" :class="indexStudy === 3 ? 'active' : ''">
